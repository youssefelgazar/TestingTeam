describe('Sign up validity',() => {
    ...
    it('triggers all type of almost complete signup',()=>{
        ...
        cy.get('#__next > main > div.signuppage__Signup-sof6g5-0.YsCoj > form > div:nth-child(7) > div.GenderSelect__FlexRow-v1a8zn-0.fRpOnE > label:nth-child(1) > span.Indicator-sc-16vj7o8-0.dDbCKU').select()
        cy.get('#day').type("2")
    ...
    it('checks logical year ',()=>{
        ...
        cy.get('#__next > main > div.signuppage__Signup-sof6g5-0.YsCoj > form > div:nth-child(6) > div:nth-child(3) > div')
                 .invoke("text")
                 .should('equal',"Enter a valid day of the month.Select your birth month.Sorry, you don't meet Spotify's age requirements.")
